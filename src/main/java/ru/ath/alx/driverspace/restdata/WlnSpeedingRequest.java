...
public class WlnSpeedingRequest {
    ...
    public WlnSpeedingRequest() {
    }

    public WlnSpeedingRequest(String userid, String token, String invnomer, String datebeg, String dateend) {
        this.userid = userid;
        this.token = token;
